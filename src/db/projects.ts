export const PROJECTS = [
  {
    ...
    technologies: ["Node.js", "Bun", "Deno", "TypeScript", "Geolocation"],
    github: "https://github.com/rohittiwari-dev/mr-geoip",
    ...
    systemNotes: [
      ...
      "Runtime-agnostic, supporting Node.js ≥ 18, Bun, and Deno.",
      "Serverless ready with a lightweight NPM shipment (only 163.4KB).",
      "Automatic HTTP fallback to public APIs if local databases are missing.",
    ],
    highlights: [
      {
        title: "Fast Lookups",
        body: "Sub-millisecond in-memory lookups powered by an LRU cache.",
        icon: "Zap",
        color: "text-cyan-300",
      },
      {
        title: "Runtime Agnostic",
        body: "Works out of the box on Node.js, Bun, and Deno environments.",
        icon: "Layers3",
        color: "text-fuchsia-300",
      },
      {
        title: "Serverless Ready",
        body: "Fully compatible with Vercel and AWS Lambda limits.",
        icon: "ServerCog",
    ...
    architecture: [
      {
        ...
        body: "Uses local databases for sub-millisecond synchronous IP lookups.",
      },
      {
        title: "HTTP Fallback",
        body: "Asynchronous fallback to public APIs like ipapi.co and FreeIPAPI.",
      },
      {
        title: "LRU Caching",
        body: "Configurable LRU cache to optimize repeated asynchronous lookups.",
      },
    ],
  },
  {
    title: "mr-email-checker",
    description:
    ...
    technologies: ["Node.js", "TypeScript", "DNS", "SMTP", "Validation"],
    github: "https://github.com/rohittiwari-dev/mr-email-checker",
    ...
    systemNotes: [
      ...
      "Live SMTP RCPT TO probe with catch-all detection.",
      "Identifies free, disposable, role, and custom mailbox domains.",
      "Typo detection using Damerau-Levenshtein distance.",
    ],
    highlights: [
      {
        title: "Zero Dependencies",
        body: "Lightweight and secure with zero external dependencies.",
        icon: "Layers3",
        color: "text-cyan-300",
      },
      {
        title: "Deep Verification",
        body: "DNS MX lookups and live SMTP probes without sending any emails.",
        icon: "ShieldCheck",
        color: "text-fuchsia-300",
      },
      {
        title: "Typo Detection",
        body: "Catches real typos like gmial.com using Damerau-Levenshtein distance.",
        icon: "Cpu",
        color: "text-emerald-300",
      },
    ],
    architecture: [
      {
        title: "Syntax & DNS Layer",
        body: "Validates RFC subsets and performs real MX lookups with A/AAAA implicit-MX fallback.",
      },
      {
        title: "SMTP Prober",
        body: "Live mailbox existence check with safe connection handling and catch-all detection.",
      },
      {
        title: "Classification Engine",
        body: "Detects disposable, free, and role-based accounts against massive community lists.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    github:
      "https://github.com/rohittiwari-dev/ocpp-ws-io/tree/main/packages/ocpp-protocol-proxy",
  ...
  },
  {
    ...
    github:
      "https://github.com/rohittiwari-dev/ocpp-ws-io/tree/main/packages/ocpp-ws-cli",
  ...
  },
  {
    ...
    technologies: ["Python", "TensorFlow", "OpenCV", "Pandas", "Deep Learning"],
    github:
      "https://github.com/rohittiwari-dev/video-classification-metadata-generation",
  ...
  },
  {
    ...
    github:
      "https://github.com/rohittiwari-dev/JARVIS-Desktop-Voice-Assistance",
...
export const OPEN_SOURCE_PROJECTS = [
  {
    ...
    url: "https://github.com/rohittiwari-dev/mr-geoip",
  },
  {
    name: "mr-email-checker",
    description:
      "Production-grade email validation & verification for Node.js — zero runtime dependencies.",
    url: "https://github.com/rohittiwari-dev/mr-email-checker",
  },
  {
    name: "OqronKit",
    description:
